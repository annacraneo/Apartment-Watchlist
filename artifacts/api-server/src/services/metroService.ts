...
const MONTREAL_METRO_STATIONS: MetroStation[] = [
  ...
  { name: "Frontenac", lat: 45.5313, lng: -73.5467, line: "Green" },
  { name: "Préfontaine", lat: 45.5372, lng: -73.5432, line: "Green" },
  { name: "Joliette", lat: 45.5503, lng: -73.5406, line: "Green" },
  { name: "Pie-IX", lat: 45.5551, lng: -73.5303, line: "Green" },
